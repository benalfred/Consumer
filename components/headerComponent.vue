      ...
      <div class="container-fluid">
        <b-navbar-brand to="/" class="brand">
          <img
            ...
            class="img-fluid Vec pt-lg-4 mt-lg-2 ml-lg-2 pl-lg-5"
            alt=""
          />
          <img
