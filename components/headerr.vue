      ...
      <b-navbar-nav class="mx-auto display-text">
          <SecNav />
           <nuxt-link  :class="[id == sector.Id ? 'color-orange' : '']"
            ...
            :key="sector.Id"
            class="d-block d-sm-none">{{ sector.Name }}
          </nuxt-link>
 ...
 <li class="d-block d-sm-none">
            ...
            <li class=" cursor-pointer action-btn mr-3 mt-lg-4">
                            <nuxt-link class="sub navigation-link" v-if="!$auth.loggedIn"  to="/join">
                                <span class="join py-1 px-4 text-white join" style="background-color: #E57718; text-decoration: none;"
                                      >Join</span>
                            </nuxt-link>
                        </li>
                        <li class="cursor-pointer action-btn ml-lg-auto mt-4 mr-3" v-if="!$auth.loggedIn">
                            <nuxt-link class="sub navigation-link" to="/login">
                                <span class="py-1 px-4 text-white"
                                      style="background-color: #E57718; text-decoration: none;">Login  <img src="~/assets/img/vector4.png" class="img-fluid pl-2" width="22" alt=""> </span>
                            </nuxt-link>
                            <!-- <nuxt-link class="sub navigation-link" to="/login">
                                <span class="py-1 px-4 text-white"
