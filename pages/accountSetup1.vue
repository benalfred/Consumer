         ...
         <div class="contact-form avenir pt-4 small raleway">
           <h3 class="text-center font-weight-bold mb-4 pb-2 pt-2">Account Setup</h3>
            <b-form  @submit.prevent="sendEmail">
              ...
              <b-form-group>
                    <b-form-input list="input-list" placeholder="Gender" id="input-with-list"></b-form-input>
                     <b-form-datalist id="input-list" :options="options"></b-form-datalist>
              </b-form-group>

              <b-form-group>
                    <b-form-input list="input-list" placeholder="State" id="input-with-list"></b-form-input>
                     <b-form-datalist id="input-list" :options="foods"></b-form-datalist>
              </b-form-group>

              <b-form-group>
                    <b-form-input list="input-list" placeholder="Local Govt Area" id="input-with-list"></b-form-input>
                     <b-form-datalist id="input-list" :options1="options"></b-form-datalist>
              </b-form-group>
  ...
  layout: 'headerr',
   data() {
    return {
      ...
      foods: ['Apple', 'mango', 'Grape', 'Kiwi', 'Orange'],
    }
  }
}
</script>
