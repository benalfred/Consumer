<template>
  <div>
    <b-container class="line_">
      <b-row class="">
        ...
        <b-col md="6" class="my-sm-5 mt-lg-5 pt-lg-5 order-sm-1 order-2 pr-md-0">
          <h1 class="hero mt-lg-2 pt-lg-3 small-hero-text hero-text">
            Explore what
            <span style="color: #e57718" class="font-weight-bold">Nigerians</span>
        ...
        <div
          style="position: absolute; left: 500px; bottom: 300px"
          class="d-none d-sm-block ml-xl-5 pl-xl-5"
        >
        ...
        <b-col
          md="6"
          class="my-sm-4 pl-5 order-sm-2 order-1 mb-0 pb-0 ml-0 px-0 offset-sm-1 offset-md-1 offset-0"
          data-aos="fade-up"
          data-aos-offset="10"
        >
          <img
            alt="Insurance made easy"
            class="mr-0 mr-lg-2 d-xl-none offset-0 offset-sm-1 offset-lg-0 img-fluid"
            src="~/assets/img/lady1.png"
          />
          <img
            alt="Insurance made easy"
            class="mr-md-2 d-none d-xl-block"
            src="~/assets/img/lady1.png"
          />
        </b-col>
      </b-row>
    ...
    <div
      ...
      style="
        position: absolute;
        background: linear-gradient(0deg, #e57718, #e57718), #ffffff;
        height: 6px;
      "
    >
    ...
    <b-container class="mt-5 pt-5">
      <b-row class="">
        <b-col md="12" class="mx-0 justify-content-center text-center">
          <h2
            style="color: #e57718"
            class="font-weight-bold hero-text"
            data-aos="fade-up"
            data-aos-offset="10"
          >
            No 1 advocacy platform in nigeria
          </h2>
          <p class="text-center lead pt-lg-5">
            We consumerHalla are team of talented people making things
            <br d-none d-md-block />
            easy for you with Our idea
          </p>
        </b-col>
        <div class="mx-0 justify-content-end">
          <div
            style="position: absolute; left: 970px"
            class="d-none d-sm-block ml-xl-5 pl-xl-5 mt-5 pt-5"
          >
    ...
    <div class="mt-5">
      <div
        ...
        style="
          position: absolute;
          background: linear-gradient(0deg, #656565, #656565), #ffffff;
          height: 6px;
        "
      >
        <div></div>
    ...
    <b-container-fluid>
      <b-row>
        <b-col md="6" class="mt-5 pt-1">
          ...
          >
            <img
              src="~/assets/img/goup12.png"
              class="img-fluid pl-lg-5 ml-lg-5 mt-3"
              alt=""
            />
          </div>
        </b-col>

        <b-col md="5" class="pl-5 my-sm-5 my-lg-auto order-sm-1 order-2 pr-md-0">
          <h1
            class="hero small-hero-text hero-text"
            data-aos="fade-right"
            data-aos-offset="10"
            data-aos-delay="100"
          >
            <span style="color: #e57718" class="font-weight-bold">Technology</span> at it
            <br class="d-none d-md-block" />
            very best
          </h1>
          <p
            class="lead1 mb-5 mt-md-4 mb-4"
            data-aos="fade-right"
            data-aos-offset="10"
            data-aos-delay="200"
          >
            Anim pariatur cliche reprehenderit, enim <br class="d-none d-md-block" />
            eiusmod high life accusamus terry <br class="d-none d-md-block" />
            richardson ad squid. 3 wolf moon officia <br class="d-none d-md-block" />
    ...
    <div class="big-image">
      <div class="">
        <h3 class="centered" data-aos-offset="10" data-aos-delay="0">
          What We Offer You
        </h3>
        <h3 class="d-block d-sm-none h3">What We Offer You</h3>
      </div>
    </div>
    ...
    <b-container class="mt-5 d-none d-sm-none d-md-block">
    ...
    <div class="big-image1">
      <b-container>
        <b-row class="mt-5 pt-xl-5">
          <b-col md="7"> </b-col>
          <b-col
            md="5"
            class="pt-5 mt-5 order-sm-1 order-2 pr-md-0"
            data-aos="flip-right"
            data-aos-offset="10"
            data-aos-delay="50"
          >
            <h1 class="hero small-hero-text hero-text font-weight-bold">
              Share your Opinion
            </h1>
            <p class="lead mb-5 mt-md-4">
              Share your own opinion and earn up to
              <span style="color: #e57718">100 points</span> to get a gift
            </p>
            <n-link
              class="button_ btn-lg text-white mt-md-5 mt-5"
              to="/register"
    ...
    <section class="section pt-5 pb-2">
      <b-container class="pt-5">
        <b-row>
          ...
          <b-col class="mt-5 pt-3 pl-lg-5 ml-lg-5">
            <div class="mt-lg-5 pl-lg-5 ml-lg-5">
              <p class="font-weight" style="color: #e57718">Sectors</p>
              <p>Technology</p>
              <p>Banking</p>
              <p>Fashion</p>
              <p>Economy</p>
      ...
      <div class="container mb-5 mt-1" style="background: #626d73; height: 1px">
        <div class="mt-2 line"></div>
      </div>
    </section>
